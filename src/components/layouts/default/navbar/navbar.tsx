        ...
        <ul className='flex h-full items-center gap-5 tracking-widest'>
          ...
          <li className='mr-4 hidden h-12 items-center md:flex'>
            <div className=''>
              <Link
                to='/'
                className='duration-[125ms] border-b-2 border-yellow-400 bg-gradient-to-t from-yellow-400 to-yellow-400 bg-[length:100%_0] bg-bottom bg-no-repeat text-sm font-semibold tracking-wide transition-[background-size] ease-in hover:bg-[length:100%_100%]'
              >
                Newsletters
              </Link>
            </div>
          </li>
          <li className='duration-[200ms] group mr-4 flex h-12 items-center bg-black bg-gradient-to-r from-yellow-400 to-yellow-400 bg-[length:0%_100%] bg-left bg-no-repeat text-xs transition-[background-size] ease-in hover:bg-[length:100%_100%]'>
            <div className='px-4'>
              <Link to='/' className=''>
