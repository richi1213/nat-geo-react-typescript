...
import { useShowImageLinks } from '@/hooks';
...
export const DiscoverMore: React.FC = () => {
  ...
  return (
    <section className='mx-auto w-full max-w-5xl space-y-16 px-0'>
      <div className='mb-6 flex flex-col items-center justify-between gap-3 sm:mb-5 sm:flex-row'>
        ...
        <UnderlinedButton className='z-[100] h-5 bg-transparent text-xs font-bold uppercase tracking-widest text-foreground hover:text-primary-foreground sm:text-center'>
          <a
